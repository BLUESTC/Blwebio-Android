...
import com.blacklighting.blwebio_android.oauth.BASE64Encoder;
...
//	}
	...
	class GetRequireTokenTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			paramsMap.add(new KeyValuePair(
					encoderStr("oauth_signature_method"),
...
//			signature =encoderStr( new String(Base64.encode(signatureBytes,Base64.DEFAULT)));

			paramsMap.add(new KeyValuePair(encoderStr("oauth_signature"),
					signature));
